...
print("AWS_ACCESS_KEY_ID loaded:", bool(AWS_ACCESS_KEY_ID))
...
def main():
    try:
        ...
        s3 = s3_connections.s3_operations(AWS_BUCKET_NAME, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY)
        df = s3.fetch_file_from_s3("data.csv")
        print(df)
        logging.info("Established Connection and data retrieved")
